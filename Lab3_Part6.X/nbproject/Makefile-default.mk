...
SOURCEFILES_QUOTED_IF_SPACED=Part6_Stepper_DRV8811.c ../src/BOARD.c ../src/AD.c ../src/LED.c Stepper.c ../src/serial.c ../src/timers.c
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Part6_Stepper_DRV8811.o ${OBJECTDIR}/_ext/1360937237/BOARD.o ${OBJECTDIR}/_ext/1360937237/AD.o ${OBJECTDIR}/_ext/1360937237/LED.o ${OBJECTDIR}/Stepper.o ${OBJECTDIR}/_ext/1360937237/serial.o ${OBJECTDIR}/_ext/1360937237/timers.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Part6_Stepper_DRV8811.o.d ${OBJECTDIR}/_ext/1360937237/BOARD.o.d ${OBJECTDIR}/_ext/1360937237/AD.o.d ${OBJECTDIR}/_ext/1360937237/LED.o.d ${OBJECTDIR}/Stepper.o.d ${OBJECTDIR}/_ext/1360937237/serial.o.d ${OBJECTDIR}/_ext/1360937237/timers.o.d
OBJECTFILES=${OBJECTDIR}/Part6_Stepper_DRV8811.o ${OBJECTDIR}/_ext/1360937237/BOARD.o ${OBJECTDIR}/_ext/1360937237/AD.o ${OBJECTDIR}/_ext/1360937237/LED.o ${OBJECTDIR}/Stepper.o ${OBJECTDIR}/_ext/1360937237/serial.o ${OBJECTDIR}/_ext/1360937237/timers.o
SOURCEFILES=Part6_Stepper_DRV8811.c ../src/BOARD.c ../src/AD.c ../src/LED.c Stepper.c ../src/serial.c ../src/timers.c
...
${OBJECTDIR}/Part6_Stepper_DRV8811.o: Part6_Stepper_DRV8811.c
	@if not exist "${OBJECTDIR}" mkdir "${OBJECTDIR}"
	${MP_CC} $(MP_EXTRA_CC_PRE) -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../include" -O1 -fno-common -MP -MMD -MF "${OBJECTDIR}/Part6_Stepper_DRV8811.o.d" -o ${OBJECTDIR}/Part6_Stepper_DRV8811.o Part6_Stepper_DRV8811.c -DXPRJ_default=$(CND_CONF) $(COMPARISON_BUILD) -mdfp="${DFP_DIR}"
...
${OBJECTDIR}/Stepper.o: Stepper.c
	@if not exist "${OBJECTDIR}" mkdir "${OBJECTDIR}"
	${MP_CC} $(MP_EXTRA_CC_PRE) -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../include" -O1 -fno-common -MP -MMD -MF "${OBJECTDIR}/Stepper.o.d" -o ${OBJECTDIR}/Stepper.o Stepper.c -DXPRJ_default=$(CND_CONF) $(COMPARISON_BUILD) -mdfp="${DFP_DIR}"
