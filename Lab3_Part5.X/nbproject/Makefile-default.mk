...
SOURCEFILES_QUOTED_IF_SPACED=Part5_Stepper_L298.c ../src/BOARD.c ../src/AD.c ../src/LED.c ../src/Stepper.c ../src/serial.c ../src/timers.c
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Part5_Stepper_L298.o ${OBJECTDIR}/_ext/1360937237/BOARD.o ${OBJECTDIR}/_ext/1360937237/AD.o ${OBJECTDIR}/_ext/1360937237/LED.o ${OBJECTDIR}/_ext/1360937237/Stepper.o ${OBJECTDIR}/_ext/1360937237/serial.o ${OBJECTDIR}/_ext/1360937237/timers.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Part5_Stepper_L298.o.d ${OBJECTDIR}/_ext/1360937237/BOARD.o.d ${OBJECTDIR}/_ext/1360937237/AD.o.d ${OBJECTDIR}/_ext/1360937237/LED.o.d ${OBJECTDIR}/_ext/1360937237/Stepper.o.d ${OBJECTDIR}/_ext/1360937237/serial.o.d ${OBJECTDIR}/_ext/1360937237/timers.o.d
OBJECTFILES=${OBJECTDIR}/Part5_Stepper_L298.o ${OBJECTDIR}/_ext/1360937237/BOARD.o ${OBJECTDIR}/_ext/1360937237/AD.o ${OBJECTDIR}/_ext/1360937237/LED.o ${OBJECTDIR}/_ext/1360937237/Stepper.o ${OBJECTDIR}/_ext/1360937237/serial.o ${OBJECTDIR}/_ext/1360937237/timers.o
SOURCEFILES=Part5_Stepper_L298.c ../src/BOARD.c ../src/AD.c ../src/LED.c ../src/Stepper.c ../src/serial.c ../src/timers.c
...
${OBJECTDIR}/Part5_Stepper_L298.o: Part5_Stepper_L298.c
	@if not exist "${OBJECTDIR}" mkdir "${OBJECTDIR}"
	${MP_CC} $(MP_EXTRA_CC_PRE) -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../include" -O1 -fno-common -MP -MMD -MF "${OBJECTDIR}/Part5_Stepper_L298.o.d" -o ${OBJECTDIR}/Part5_Stepper_L298.o Part5_Stepper_L298.c -DXPRJ_default=$(CND_CONF) $(COMPARISON_BUILD) -mdfp="${DFP_DIR}"
...
${OBJECTDIR}/_ext/1360937237/Stepper.o: ../src/Stepper.c
	@if not exist "${OBJECTDIR}/_ext/1360937237" mkdir "${OBJECTDIR}/_ext/1360937237"
	${MP_CC} $(MP_EXTRA_CC_PRE) -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../include" -O1 -fno-common -MP -MMD -MF "${OBJECTDIR}/_ext/1360937237/Stepper.o.d" -o ${OBJECTDIR}/_ext/1360937237/Stepper.o ../src/Stepper.c -DXPRJ_default=$(CND_CONF) $(COMPARISON_BUILD) -mdfp="${DFP_DIR}"
