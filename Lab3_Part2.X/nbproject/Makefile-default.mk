...
SOURCEFILES_QUOTED_IF_SPACED=Part2_DS3658.c ../src/BOARD.c ../src/AD.c ../src/LED.c ../src/pwm.c ../src/serial.c ../src/timers.c
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Part2_DS3658.o ${OBJECTDIR}/_ext/1360937237/BOARD.o ${OBJECTDIR}/_ext/1360937237/AD.o ${OBJECTDIR}/_ext/1360937237/LED.o ${OBJECTDIR}/_ext/1360937237/pwm.o ${OBJECTDIR}/_ext/1360937237/serial.o ${OBJECTDIR}/_ext/1360937237/timers.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Part2_DS3658.o.d ${OBJECTDIR}/_ext/1360937237/BOARD.o.d ${OBJECTDIR}/_ext/1360937237/AD.o.d ${OBJECTDIR}/_ext/1360937237/LED.o.d ${OBJECTDIR}/_ext/1360937237/pwm.o.d ${OBJECTDIR}/_ext/1360937237/serial.o.d ${OBJECTDIR}/_ext/1360937237/timers.o.d
OBJECTFILES=${OBJECTDIR}/Part2_DS3658.o ${OBJECTDIR}/_ext/1360937237/BOARD.o ${OBJECTDIR}/_ext/1360937237/AD.o ${OBJECTDIR}/_ext/1360937237/LED.o ${OBJECTDIR}/_ext/1360937237/pwm.o ${OBJECTDIR}/_ext/1360937237/serial.o ${OBJECTDIR}/_ext/1360937237/timers.o
SOURCEFILES=Part2_DS3658.c ../src/BOARD.c ../src/AD.c ../src/LED.c ../src/pwm.c ../src/serial.c ../src/timers.c
...
${OBJECTDIR}/Part2_DS3658.o: Part2_DS3658.c
	@if not exist "${OBJECTDIR}" mkdir "${OBJECTDIR}"
	${MP_CC} $(MP_EXTRA_CC_PRE) -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../include" -O1 -fno-common -MP -MMD -MF "${OBJECTDIR}/Part2_DS3658.o.d" -o ${OBJECTDIR}/Part2_DS3658.o Part2_DS3658.c -DXPRJ_default=$(CND_CONF) $(COMPARISON_BUILD) -mdfp="${DFP_DIR}"
